...
class ControllerExtensionModuleRevolutionSlider extends Controller {
    ...
    public function index($setting){ 
        ...
        define('rs_rs_plugin', rs_plugin_url.'public/assets/');
...
// start revsliderfront setting 
    $sliders = $this->hookCommonCb($setting['slider_id']);   
        ...
        RevSliderOutput::putSlider($setting['slider_id'], '',array(),array(),array(),$this->session->data['language']);
    ...
    protected function _prehook() {
        require_once DIR_CONFIG . 'revslider/revslider-front.class.php'; 
